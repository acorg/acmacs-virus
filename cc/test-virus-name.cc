...
void test_builtin()
{
    ...
    const std::array data{
        ...
        // TestData{"A/mallard/Balkhas/6304_HA/2014",                  to_compare_t{A, host_t{"MALLARD"}, "BALKHAS", "6304", "2014", R, E}},
        // TestData{"A/SWINE/NE/55024/2018",       to_compare_t{A, host_t{"SWINE"}, "NE", "55024", "2018"}, R, E}},
        // TestData{"A/chicken/Iran221/2001",       to_compare_t{A, host_t{"", R, E}},
        // TestData{"A/BiliranTB5/0423/2015",       to_compare_t{A, host_t{"", R, E}},
        // TestData{"A/chicken/Yunnan/Kunming/2007",       to_compare_t{A, host_t{"CHICKEN"}, R, E}},
